const data = [
  ...
  },
  {
    ...
    TITOL: "Desfragment",
    ABSTRACTS:
      "Desfragment és un còmic que narra escenes d'un personatge femení en diferents moments vitals com el divorci, el part i una trobada virtual amb l'amant. Es un exercici de narrativa per explicar sensacions més que fets concrets, fent ús dels recursos del còmic i bevent d'altres gràfiques, com la arquitectònica. Desfragmentar és un procés informàtic que consisteix en reguardar els arxius per tal d'optimitzar l'espai del disc dur. Un exercici que podríem fer els humans cada cert temps: endreçar els records per tenir més espai per viure'n de nous. El Desfragment és el resultat d'un viatge a la recerca d'un sistema propi de plantejar un relat gràfic, després de practicar el dibuix a la deriva per tal de trobar una motivació autèntica.",
    TIPOLOGIA: "Visual",
    SRC: "clara-tanit-arque",
  },
  {
    ALUMNE: "Clàudia Vilanova Beneyto",
    TITOL: "Angst",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Pertene-ser",
    ABSTRACTS:
      "Aquest projecte de recerca és una col·lecció de quatre capítols il·lustrats relacionats sobre el procés migratori i la cerca de pertanyer novament després d'arrencar les teves arrels de manera forçosa per circumstancies polítiques, economiques i socials del país de procedencia i com aquest procés es poi veure representat de manera censurada pel nostre subconscient a través deis somnis. A cada capítol es parla d'experiencies reals, extretes de tallers presencials on es van tractar temes com els somnis, la llar i la pertinença. L'objectiu final d'aquesta proposta és generar un dispositiu visual que ajudi a crear un espai de catarsi i posada en comú d'experiencies relacionarles amb els moviments migratoris. Per tant, la intenció d'aquest projecte sera encoratjar el col·lectiu immigrant a generar espais on puguin compartir les seves vivencies i crear un grup on puguin sentir que pertanven. ",
    TIPOLOGIA: "Visual",
    SRC: "gabriela-dalforno",
  },
  {
    ALUMNE: "Juan Esteban Salamanca Toro",
    TITOL: "EJE Z",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Retalls",
    ABSTRACTS:
      "Retalls és un foto llibre familiar. Elaborat a partir de les fotografies del meu propi arxiu familiar amb l'objectiu de traslladar al lector al seu propi arxiu mental i s'hi pugui sentir identificat. La imatge i el blanc creen un joc on es privatitza la identitat de qualsevol persona o lloc per a deixar lloc a la imaginació amb l'incentiu d'un retall d'imatge. El fil conductor de principi a final va entrellaçant els espais que ens envolten, les relacions d'efecte que tenim, el pas del temps i èpoques de la nostra vida en grups d'imatges classificades respectivament.",
    TIPOLOGIA: "Visual",
    SRC: "julia-fernandez",
  },
  {
    ALUMNE: "Laia Badenas Martí",
    TITOL: "El saber de les flors",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Oidà",
    ABSTRACTS:
      "És possible crear i conviure des de les diferències? Podem arribar a viure des del “sí col·lectiu” en la nostra societat actual? Oidà és una performance visual que ens invita a reflexionar sobre la societat actual mitjançant diferents llenguatges, dels quals acaben formant la peça final. Un projecte transmèdia experimental que investiga com transmetre la visió d'en Zygmunt Bauman i la Lynn Margulis des d'una mirada de creadora visual fins a la d'una coreògrafa de dansa-teatre, realitzant d'aquesta manera un híbrid entre aquestes dues rames artístiques.",
    TIPOLOGIA: "Visual",
    SRC: "nuria-martinez",
  },
  {
    ALUMNE: "Paul Verant Garcia",
    TITOL: "Drop the chains",
    ABSTRACTS:
      "El concepte d'esclavitud sovint s'associa amb la distància i el passat, i no obstant hi ha més persones en situació d'esclavitud avui dia que en qualsevol altre moment de la història. I dels més de 25 milions de persones que són explotades cada dia segons l'OIT (Organització Internacional del Treball), la majoria treballa al servei dels interessos de la nostra societat occidental. Aquest projecte és una campanya de sensibilització il·lustrada de 20 dies contra l'esclavatge laboral en les seves diverses formes. El seu objectiu és posar en evidència les condicions de treball inhumanes que hi ha darrere d'alguns productes de la nostra vida quotidiana, i la nostra responsabilitat com a occidentals a través del nostre consum.",
    TIPOLOGIA: "Visual",
    SRC: "paul-verant",
  },
  {
    ALUMNE: "Paula Mateu Borràs",
    TITOL: "Àncora",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "P.H.E / P.B.P.",
    ABSTRACTS:
      "P.H.E / P.B.P. és un projecte tèxtil amb l'objectiu d'entendre les experiències biològiques i socials que construiran el gènere d'una persona. Es presenta una peça tèxtil, en la que es transcriu de manera gràfica i abstracte, la documentació teòrica i experimental sobre el gènere i la sexualitat, recollida del pensador Paul B. Preciados en el seu llibre “Testo Yonqui”, i la interpretació de Pedro Hita Exposito (jo) a aquesta documentació.La investigació del projecte se centra en els elements polítics que envolten a una societat i com aquests elements són essencials per generar la identitat i la sexualitat d'una persona. La materialització de les influències sociopolítiques es traspassen al cos (objecte substancial en matèria omplert de conceptes i identitats) i a l'expressió del propi cos (moda/tèxtil).",
    TIPOLOGIA: "Visual",
    SRC: "pedro-hita",
  },
  {
    ALUMNE: "Roberto Espinosa Menéndez",
    TITOL: "NFT for dummies",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Potser no va passar'",
    ABSTRACTS:
      "Potser no va passar vol ser un tros de memòria col·lectiva, on, a través de la fusió de pel·lícules casolanes amb cartes i postals de diversa procedència, es crea la imatge d'un passat imaginari i subjectiu, però també verídic i fidedigne a la realitat. Aquest projecte dona peu a una reflexió sobre el pas del temps, com afecta la nostre manera de viure i entendre el món, entenent el passat com una part de les nostres vides que ja no s'esdevindrà de nou, però que, per sort, sí podem re-viure a partir dels records i el material d'arxiu.",
    TIPOLOGIA: "Visual",
    SRC: "violeta-araujo",
  },
  {
    ALUMNE: "Berta Clotet Pujols",
    TITOL: "Entangle-mind",
    ABSTRACTS:
      "Aquest projecte neix d'un desig per entendre els problemes embrollats que entreteixeixen tota mena de vides en el nus entortolligat que compon el nostre món. Va de la manera que té la natura de teixirse a si mateixa a la tela infinita de la vida. Va de que tot és el mateix alhora. De tornar-se humus un altre cop. Esdevenir una sola unitat amb el paisatge que ens envolta. Aquest projecte visualitza a través de paraules i imatges els nusos entre disseny i natura, expandint el nostre punt de vista per fer-ne créixer un d'intricat.",
    TIPOLOGIA: "Cultura",
    SRC: "berta-clotet",
  },
  {
    ALUMNE: "Berta Górriz Fernández",
    TITOL: "Privilegios",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Middetown: In redefinition",
    ABSTRACTS:
  ...
  {
    ALUMNE: "Antoni Grabulosa Rodero",
    TITOL: "BÈSTIA!",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Humanitzar una planta de Salut Mental",
    ABSTRACTS:
      "Creació d'un espai humanitzador i versàtil a la planta de salut mental de l'Hospital de Terrassa; amb l'objectiu de promocionar la recuperació en col·lectivitat, tenint en compte agents externs a la farmacologia, per tal de millorar de manera passiva l'assistència als pacients després de patir una crisi aguda.",
    TIPOLOGIA: "Espais",
    SRC: "clara-isern",
  },
  {
    ALUMNE: "Estel Homs Romagosa",
    TITOL: "Reminiscència",
    ABSTRACTS:
      "Es tracte d'un centre deluxe, adaptatiu, que és capaç de resoldre les darrereres voluntats d'un malalt terminal. Proporciona comoditat i serenor a la persona en qúestió i als seus acompanyants i/o familiars.",
    TIPOLOGIA: "Espais",
    SRC: "estel-homs",
  },
  {
  ...
  },
  {
    ...
    TITOL: "Centro de investigación de la danza",
    ABSTRACTS:
  ...
  {
    ALUMNE: "Laura Balsa Molero",
    TITOL: "Can'animal",
    ABSTRACTS:
      "El projecte planteja la reforma d'un refugi situat a La Garrotxa, Girona, als afores del poble de Maià de Montcal. Donat que la societat cada cop tendeix més a incorporar un animal a la seva família, és necessari adaptar els espais a tota mena de fauna. És per aquest motiu que neix Can'Animal, un refugi pet-friendly que té per objectiu unificar els espais per a humans i per a animals, i fusionar aquests dos mons fins aleshores dividits. Aquest projecte consisteix en la reforma d'un espai que actualment no té un ús determinat, es planteja adequar la construcció per tal de crear un refugi on humans i animals puguin ser allotjats sense divisions.",
    TIPOLOGIA: "Espais",
    SRC: "laura-balsa",
  },
  {
    ALUMNE: "Laura Estrany Perez",
    TITOL: "A trenc de mar",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Revoltes",
    ABSTRACTS:
      "Revoltes és un projecte de recuperació històrica de la Capella dels Segadors i la plaça de les Dones de la Motor Ibèrica, a través de les arreIs agrícoles i obreresdel passat de Sant Andreu del Palomar. Mitjançant la unió dels dos espais es crea una nova zona d'ús públic que commemora fets històrics del moviment social, prenent com a protagonistes el pas del temps i la gent del barri.",
    TIPOLOGIA: "Espais",
    SRC: "nuria-carrascal",
  },
  {
  ...
  },
  {
    ...
    TITOL: "Aniràbé",
    ABSTRACTS:
      "ANIRÀBÉ és el nom que reb la nova cadena hotelera amb 8 establiments turístics a Menorca i 2 més en reforma a l'illa de Mallorca. Es disposa des d'apartaments familiars de sol i platja i d'altres més urbans. Aquests segons són hotels boutique per a un públic adult, parelles sense fills amb un interès més cultural. Tots els establiments tenen una nula identificació de marca, no disposen de web genèrica i això provoca les conseqüents dificultats de comercialització. Aquest projecte real inclou la identitat visual aplicada a una sèrie de suports de comunicació, disseny de la web i fotografies dels hotels, material promocional i senyalització d'espais.",
    TIPOLOGIA: "Gràfic",
    SRC: "antoni-salom",
  },
  {
    ALUMNE: "Beatriz Llorca Jack",
    TITOL: "ITS a problem",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Nuttys",
    ABSTRACTS:
      "Segons els nutricionistes i altres experts, es recomana ingerir entre 20- 30 gr (sense closca) de fruits secs al dia. Nuttys és un projecte de packaging ecològic que afavoreix a la consumició responsable i sostenible dels fruits secs de consumició immediata. Per poder exercir correctament aquests objectius, s'ha desenvolupat una sèrie de quatre packs, segons el fruit sec que conté, que podran ser rentats i recarregats a qualsevol botiga a granel de Barcelona un cop que el seu contingut s'hagi esgotat.",
    TIPOLOGIA: "Gràfic",
    SRC: "irene-extremeno",
  },
  {
    ALUMNE: "Nil Vila Martos",
    TITOL: "Radiante",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Arxiu Obert",
    ABSTRACTS:
      "Arxiu Obert és un projecte editorial basat en les nombroses exposicions temporals que any rere any realitza el Arxiu Municipal del Prat de Llobregat. Aquestes exposicions, gratuïtes per al públic, estan destinades a donar a conèixer la història del municipi, ja sigui des d'una visió general i de com van afectar uns certs moviments històrics, socials o geològics en ell, o tractant temàtiques concretes i més particulars de la ciutat o dels seus habitants.Tot el material que es genera a l'hora de dur a terme les exposicions (des de textos, recopilació i mostra de documents i fotografies, entrevistes etc.), una vegada que finalitzen no queda constància de tot això més enllà de, en algunes ocasions, un petit fullet explicatiu d'aquesta, o un arxiu en format digital. És per això que en aquest Treball Final de Grau es pretén donar una nova vida a tot aquest esforç i aquest material perquè perduri en el temps, creant una línia editorial. Una col·lecció de llibres que s'anirà engrandint amb el pas dels anys i que, fruit de les exposicions, serviran per a la seva consulta, estudi i record, però amb una personalitat pròpia independent de la gràfica de les exposicions dels quals sorgeixen.",
    TIPOLOGIA: "Gràfic",
    SRC: "oscar-calzada",
  },
  {
    ALUMNE: "Pau Morató Sebastià",
    TITOL: "Rooting",
    ABSTRACTS:
  ...
  {
    ALUMNE: "Ruben Córdoba Schwaneberg",
    TITOL: "Appart",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "Creació d'una marca de moda ètica",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "BULLDER",
    ABSTRACTS:
      "Aquest treball consisteix a elaborar un producte que afavoreixi la progressió dels atletes de força, així com potenciar indirectament la projecció d'aquest esport fantàstic. Per aconseguir aquest esdeveniment s'ha fet una revisió de les opcions existents i s'ha replantejat completament el sistema, fent-ne un de nou.",
    TIPOLOGIA: "Producte",
    SRC: "eliseu-poch",
  },
  {
    ALUMNE: "Gabriel Sagarra Altes",
    TITOL: "Goldfish",
    ABSTRACTS:
      "La intenció d'aquest treball de recerca és la creació d'una peixera destinada a peixos d'aigua dolça fàcils de mantenir, els quals moltes vegades es deixen en un racó de la casa i han de passar tota la seva vida en un espai petit oblidats pels seus propietaris. L'objectiu pricipal és crear un hàbitat per aquest animal domèstic, amb el qual és difícil relacionar-se a causa de la diferència de medis. El que volem aconseguir és un espai net perquè l'humà pugui sentir l'entorn d'aquest individu, en comptes de ser un simple recipient on posar al peix i així aconseguir que aquest animal sigui més notori en l'espai domèstic. D'aquesta manera, volem trobar una forma més fàcil d'interaccionar i relacionar-se amb aquest ésser viu, ja que la diferència entre hàbitats fa que aquesta relació sigui molt difícil. Per aconseguir aquesta relació amb el peix, volem convertir la peixera en un element lumínic que pugui traduir les sensacions del peix dintre l'aigua en l'espai desitjat per l'usuari, a través de reflexos i ombres fetes a partir dels moviments de l'aigua i les ombres dels peixos, traduint aquestes sensacions que té el peix dintre de la peixera a l'espai de l'esser humà.",
    TIPOLOGIA: "Producte",
    SRC: "gabriel-sagarra",
  },
  {
    ALUMNE: "Gerard Jorba Casas",
    TITOL: "Dogrider",
    ABSTRACTS:
      "Com a aficionat al ciclisme de muntanya i com a propietari de dos gossos adoptats, m'he adonat que quan practiquem aquest hobby junts apareixen certes dificultats que no ens permeten gaudir del moment. Els problemes del seu passat, com possibles maltractaments o situacions d'estrès en la seva època de creixement i la falta al mercat d'un producte adequat per iniciar-se en aquest àmbit fan que aquesta pràctica es converteixi en un suplici. Dog Rider neix de l'anàlisi de productes existents amb diferents mètodes de subjecció que presenten problemes que afecten sobretot a la fase d'iniciació on la majoria de gossos, sobretot rescatats, poden manifestar moltes dificultats. He creat un producte universal el qual permetrà subjectar els cans al voltant de la bicicleta, mantenint-los a una distància prudencial el qual permetrà gaudir el passeig i educar i millorar la conducta de l'animal de forma segura. Dog Rider permetrà crear una connexió entre la mascota i l'humà enfortint el vincle més allà de l'amistat.",
    TIPOLOGIA: "Producte",
    SRC: "gerard-jorba",
  },
  {
    ALUMNE: "Guillem Hernández Bujadós",
    TITOL: "Serinus",
    ABSTRACTS:
      "Serinus és un projecte que neix de la necessitat de reaprofitar materials de primera qualitat utilitzats en cicles de vida únics, fet que propicia un malbaratament massiu de les existències finites del nostre planeta. El projecte Serinus s'ubica al món vinícola i el seu sistema logístic, que utilitza caixes de fusta pel transport de les seves mercaderies, provocant una tala massiva d'arbres a la península. Aquestes caixes després d'haver acomplert la seva principal funció són desestimades, en la seva majoria, provocant un cicle de vida molt reduït i il·lustrant el mal ús d'aquest material tan noble. En aquest context sorgeix Serinus, una col·lecció de tres nius d'ocells produïts mitjançant la fusta residual de la logística de l'enologia i dotant d'una segona vida aquestes caixes, vinculant-les a vinyers orgànics, allargant el seu cicle de vida a través de pràctiques sostenibles i ecològiques, retornant així, la fusta a la natura i contribuint al medi ambient.",
    TIPOLOGIA: "Producte",
    SRC: "guillem-hernandez",
  },
  {
    ALUMNE: "Irene Alcázar Gallofré",
    TITOL: "Amics",
    ABSTRACTS:
      "El meu TFG explora els vincles que els humans tenim amb els objectes a través de la teoria de la O.O.O de Graham Harman, l'assaig de El poder de lo cuqui de Simon May i l'objecte transicional de Winnicott. D'aquestes tres teories pretenc extreure una forma de generar un objecte singular, que trenqui amb la jerarquia subjecte-objecte tradicional, a l'hora de relacionar-te i establir un vincle amb ell. Així mateix, volia donar-li el valor afegit de què aquest objecte ajudes a la salut mental de l'humà a qui acompanyés.\r\nPartint d'aquesta base teòrica trobem que, un objecte que s'adapta perfectament a les característiques que busquem, és la joguina, i els millors usuaris per a les joguines són els nens. Així doncs, em vaig posar en contacte amb una psicòloga infantil amb la qual vam dur a terme aquest projecte de codesign.",
    TIPOLOGIA: "Producte",
    SRC: "irene-alcazar",
  },
  {
    ALUMNE: "Juan Manuel Valencia Moreno",
    TITOL: "Social Gear",
    ABSTRACTS:
  ...
  },
  {
    ...
    TITOL: "L'objecte Poeticofuncional",
    ABSTRACTS:
...
// let arrayFiltered = data.filter(SRC, projectName);
...
const func3d = () => {
  for (let i = 0; i < data.length; i++) {
    if (data[i]["SRCVideo"] === projectName) {
      return data[i];
    }
  }
};

console.log(`Result func3d: ${func().SRCVideo}`);
...
if (func().SRC === projectName) {
  const pdfAlumnes = document.querySelector(".memory-div");
  pdfAlumnes.innerHTML = `<a class="memory" id="memory" href="./assets/tfg/${projectName}.pdf"
  >Consulta la memòria</a>`;
}
